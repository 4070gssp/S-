...
.banner-wrap{
  ...
  overflow:hidden;
  margin-bottom:14px;
  box-shadow:0 6px 24px rgba(255,100,150,.25);
}
...
.rbadge{
  font-family:'Dela Gothic One',sans-serif;font-size:22px;
  padding:8px 28px;border-radius:50px;
  animation:popIn .45s cubic-bezier(.2,1.5,.5,1) both;
}
...
.btn-spin:active{transform:translateY(4px);box-shadow:0 1px 0 #cc3366,0 2px 6px rgba(255,100,150,.2);}
.btn-spin:disabled{opacity:.4;cursor:not-allowed;filter:none;}

/* ===== COUPONS ===== */
.sec-lbl{
  font-size:12px;color:#b07a10;text-align:center;
...
<div class="wrap">
  ...
  <svg width="100%" viewBox="0 0 380 200" role="img" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="18" cy="18" r="5" fill="rgba(255,255,255,.25)"/>
    <circle cx="50" cy="8"  r="3" fill="rgba(255,255,255,.20)"/>
    <circle cx="340" cy="15" r="6" fill="rgba(255,255,255,.22)"/>
    <circle cx="365" cy="40" r="4" fill="rgba(255,255,255,.18)"/>
    <circle cx="10"  cy="80" r="4" fill="rgba(255,255,255,.20)"/>
    <circle cx="370" cy="160" r="5" fill="rgba(255,255,255,.22)"/>
    <circle cx="25"  cy="175" r="3" fill="rgba(255,255,255,.18)"/>
    <circle cx="355" cy="190" r="4" fill="rgba(255,255,255,.20)"/>
    <path d="M0,30 Q47,10 95,28 Q142,46 190,28 Q238,10 285,28 Q332,46 380,28 L380,0 L0,0 Z" fill="rgba(255,255,255,.18)"/>
    <path d="M0,172 Q47,190 95,172 Q142,154 190,172 Q238,190 285,172 Q332,154 380,172 L380,200 L0,200 Z" fill="rgba(255,255,255,.18)"/>
    <g transform="translate(32,38) rotate(-15)">
      <polygon points="0,-14 4,-5 13,-5 6,1 9,11 0,5 -9,11 -6,1 -13,-5 -4,-5" fill="#FFFFFF" opacity=".9"/>
    </g>
    <g transform="translate(348,45) rotate(10)">
      <polygon points="0,-10 3,-3 10,-3 4,1 7,8 0,4 -7,8 -4,1 -10,-3 -3,-3" fill="#FFFFFF" opacity=".85"/>
    </g>
    <g transform="translate(28,155) rotate(8)">
      <polygon points="0,-9 2.5,-3 9,-3 4,1 6,7 0,3.5 -6,7 -4,1 -9,-3 -2.5,-3" fill="#FFE566" opacity=".9"/>
    </g>
    <g transform="translate(352,148) rotate(-12)">
      <polygon points="0,-11 3,-4 11,-4 5,1 7,9 0,5 -7,9 -5,1 -11,-4 -3,-4" fill="#FFE566" opacity=".88"/>
    </g>
    <g transform="translate(68,160) rotate(5)">
      <polygon points="0,-7 2,-2 7,-2 3,1 5,6 0,3 -5,6 -3,1 -7,-2 -2,-2" fill="rgba(255,255,255,.75)"/>
    </g>
    <g transform="translate(312,60) rotate(-8)">
      <polygon points="0,-7 2,-2 7,-2 3,1 5,6 0,3 -5,6 -3,1 -7,-2 -2,-2" fill="rgba(255,255,255,.75)"/>
    </g>
    <circle cx="58" cy="100" r="26" fill="url(#coinGrad)" stroke="#C88010" stroke-width="2"/>
    <circle cx="58" cy="100" r="20" fill="none" stroke="rgba(255,255,210,.5)" stroke-width="1.5"/>
    <text x="58" y="106" text-anchor="middle" font-family="'Dela Gothic One',sans-serif" font-size="16" font-weight="700" fill="#7a4a00">¥</text>
    <circle cx="322" cy="100" r="26" fill="url(#coinGrad)" stroke="#C88010" stroke-width="2"/>
    <circle cx="322" cy="100" r="20" fill="none" stroke="rgba(255,255,210,.5)" stroke-width="1.5"/>
    <text x="322" y="106" text-anchor="middle" font-family="'Dela Gothic One',sans-serif" font-size="16" font-weight="700" fill="#7a4a00">¥</text>
    <rect x="88" y="30" width="204" height="50" rx="14" fill="rgba(255,255,255,.22)"/>
    <text x="190" y="60" text-anchor="middle" font-family="'Dela Gothic One',sans-serif" font-size="26" font-weight="900" fill="#FFFFFF" stroke="#FF6B00" stroke-width="4" stroke-linejoin="round" paint-order="stroke">お駄賃</text>
    <text x="190" y="90" text-anchor="middle" font-family="'Dela Gothic One',sans-serif" font-size="19" font-weight="900" fill="#FFFFFF" stroke="#CC4400" stroke-width="3.5" stroke-linejoin="round" paint-order="stroke">決定！抽選ガラポン</text>
    <rect x="100" y="102" width="180" height="28" rx="14" fill="rgba(255,255,255,.30)"/>
    <text x="190" y="121" text-anchor="middle" font-family="'Kosugi Maru',sans-serif" font-size="13" font-weight="700" fill="#7a1a00">おてつだい1回 → 1回まわせるよ！</text>
    <rect x="98"  y="140" width="52" height="44" rx="10" fill="#FFD700" stroke="#C88800" stroke-width="1.5"/>
    <text x="124" y="157" text-anchor="middle" font-family="'Dela Gothic One',sans-serif" font-size="10" fill="#7a4a00">1等</text>
    <text x="124" y="174" text-anchor="middle" font-family="'Dela Gothic One',sans-serif" font-size="13" fill="#7a3000">300円</text>
    <rect x="158" y="140" width="52" height="44" rx="10" fill="#E8E8E8" stroke="#AAAAAA" stroke-width="1.5"/>
    <text x="184" y="157" text-anchor="middle" font-family="'Dela Gothic One',sans-serif" font-size="10" fill="#444">2等</text>
    <text x="184" y="174" text-anchor="middle" font-family="'Dela Gothic One',sans-serif" font-size="13" fill="#333">100円</text>
    <rect x="218" y="140" width="52" height="44" rx="10" fill="#FFB347" stroke="#CC7700" stroke-width="1.5"/>
    <text x="244" y="157" text-anchor="middle" font-family="'Dela Gothic One',sans-serif" font-size="10" fill="#7a3a00">3等</text>
    <text x="244" y="174" text-anchor="middle" font-family="'Dela Gothic One',sans-serif" font-size="13" fill="#7a3000">50円</text>
    <rect x="278" y="148" width="44" height="36" rx="9" fill="#ADE8F4" stroke="#4499BB" stroke-width="1.5"/>
    <text x="300" y="162" text-anchor="middle" font-family="'Dela Gothic One',sans-serif" font-size="9" fill="#1a5566">参加賞</text>
    <text x="300" y="176" text-anchor="middle" font-family="'Dela Gothic One',sans-serif" font-size="12" fill="#1a4455">10円</text>
  ...
  <div class="game-card">
    <div class="stage">
      ...
      <svg id="gpSvg" width="100%" viewBox="0 0 340 220" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle id="flyShine" cx="105" cy="147" r="0" fill="rgba(255,255,255,.7)" opacity="0"/>
...
<script>
const PRIZES=[
  {rank:1,label:'🥇 1等！ 300円',bc:'b1',ballFill:'#FFD700',ballStroke:'#B8860B',emoji:'🌟',amount:300,chance:.005},
  {rank:2,label:'🥈 2等！ 100円',bc:'b2',ballFill:'#DDDDDD',ballStroke:'#888888',emoji:'⭐',amount:100,chance:.03},
  {rank:3,label:'🥉 3等！ 50円', bc:'b3',ballFill:'#FF9933',ballStroke:'#CC6600',emoji:'✨',amount:50, chance:.05},
  {rank:0,label:'🎀 参加賞 10円', bc:'b0',ballFill:'#66AAEE',ballStroke:'#3366BB',emoji:'🎁',amount:10, chance:1},
];
let spinning=false,coupons=[];
...
function genId(){
  return 'CP-'+Date.now().toString(36).toUpperCase().slice(-5)+'-'+String(Math.floor(Math.random()*1000)).padStart(3,'0');
}
...
function animDrum(onDone){
  ...
  function frame(ts){
    ...
    ids.forEach((id,i)=>{
      ...
      const shift=((phase*2+i*18)%38)-19;
    ...
    if(t<1){requestAnimationFrame(frame);}
      ...
      ids.forEach((id,i)=>{
        const el=document.getElementById(id);
        el.setAttribute('x1',baseX[i]);el.setAttribute('x2',baseX[i]);
      });
      onDone();
    }
  }
...
function ringBell(){
  const g=document.getElementById('bellG');
  const rays=['br1','br2','br3'];
  let t=0;const frames=48;
  function step(){
    t++;
    const a=Math.sin(t/3.5)*24*Math.max(0,(frames-t)/frames);
    g.setAttribute('transform','rotate('+a+',52,96)');
    const show=t>10&&t<38;
    rays.forEach(id=>document.getElementById(id).setAttribute('opacity',show?'1':'0'));
    if(t<frames){requestAnimationFrame(step);}
    else{
      g.setAttribute('transform','');
      rays.forEach(id=>document.getElementById(id).setAttribute('opacity','0'));
    }
  }
  requestAnimationFrame(step);
}

function animBall(prize,onDone){
  const ball=document.getElementById('flyBall');
  const shine=document.getElementById('flyShine');
  ball.setAttribute('fill',prize.ballFill);
  ball.setAttribute('stroke',prize.ballStroke);
  let t=0;const frames=55;
  const sx=108,sy=150,ex=50,ey=108;
  function step(){
    t++;
    const p=t/frames;
    const ep=1-(1-p)*(1-p);
    const x=sx+(ex-sx)*ep;
    const y=sy+(ey-sy)*ep-Math.sin(p*Math.PI)*32;
    const r=10*Math.min(p*4,1);
    ...
    shine.setAttribute('r',r*.3);shine.setAttribute('opacity','1');
    if(t<frames){requestAnimationFrame(step);}
    else{
      setTimeout(function(){
...
function showConfetti(prize){
  ...
  const w=document.getElementById('confBox');
  w.innerHTML='';
  const cols=['#FFD700','#FF6B6B','#4ECDC4','#45B7D1','#96CEB4','#FFEAA7','#A29BFE'];
  for(let i=0;i<28;i++){
    ...
    el.style.animationDuration=(.85+Math.random()*.5)+'s';
    w.appendChild(el);
  }
  setTimeout(function(){w.innerHTML='';},2500);
}
...
function doSpin(){
  ...
  animDrum(function(){
    ringBell();
    animBall(prize,function(){
      showConfetti(prize);
      document.getElementById('resultArea').innerHTML=
        '<span class="rbadge '+prize.bc+'">'+prize.label+'</span>';
      issueCoupon(prize);
      spinning=false;
